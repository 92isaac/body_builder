      ...
      <div className="gym-guy md:w-[70%] flex justify-center items-center mx-auto pt-10 pb-32 px-10">
        <div className="flex-1 text-white">
          ...
          <p className="text-sm leading-8">
            We design our clubs to give you the most awesome workouts possible.
            That’s why our dedicated group fitness studios are four walls of
            innovative, hard work, fun.
          </p>
        </div>
